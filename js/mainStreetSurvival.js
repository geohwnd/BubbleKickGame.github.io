...
// Filtro visual tipo arcade/toon: más color, contraste y brillo sin tocar texturas.
renderer.domElement.style.filter = "saturate(1.5) contrast(1.9) brightness(0.5)";
...
const DEFAULT_CAMERA_POSITION = new THREE.Vector3(0, 12, 18);
const MOBILE_CAMERA_OFFSET = new THREE.Vector3(0, 11.5, 12.5);
...
function resize() {
  ...
  camera.fov = width < 700 && height > width ? 52 : 45;
...
const fill = new THREE.DirectionalLight(0xddeeff, 3.2);
...
stadiumEnvironmentSound.volume = 0.32;
